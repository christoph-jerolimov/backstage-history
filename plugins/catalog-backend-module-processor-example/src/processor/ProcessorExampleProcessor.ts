 ...
 */
export class ProcessorExampleProcessor implements CatalogProcessor {
  static fromConfig(_config: Config): ProcessorExampleProcessor {
    return new ProcessorExampleProcessor();
  }

  getProcessorName(): string {
    return 'ProcessorExampleProcessor';
  }
